...
{
    ui->setupUi(this);
    ui->LineEditPassword1->setEchoMode(QLineEdit::Password);  // Set password to appear as dots
    ui->LineEditPassword2->setEchoMode(QLineEdit::Password);  // Set password to appear as dots
}
