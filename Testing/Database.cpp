...
void database_t::Update_Score_Table(std::string player_name,unsigned int games_won,unsigned int games_lost,unsigned int games_draw){
...
void database_t::Get_Score(std::string name,unsigned int& won,unsigned int& lost,unsigned int& draw){
